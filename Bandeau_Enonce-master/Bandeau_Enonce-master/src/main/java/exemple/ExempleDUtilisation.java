...
public class ExempleDUtilisation {
    ...
    public static void main(String[] args) {
        ...
        new ExempleDUtilisation().exempleScenario();
    }
    ...
    public void exempleScenario() {
    	Scenario scenario = new Scenario();
    	
    	Effet clignoter = new Clignoter(1000, 1);
    	Effet faireUnTour = new FaireUnTour(1000, 100);
    	Effet changerFond = new ChangerFond(1000, Color.BLUE, Color.YELLOW);
    	
    	scenario.ajouterEffet(clignoter, 1);
    	scenario.ajouterEffet(faireUnTour, 1);
    	scenario.ajouterEffet(changerFond, 1);
    	
    	Bandeau monBandeau = new Bandeau();
    	monBandeau.setMessage("Hello");
    	
    	scenario.jouer(monBandeau);
    }
}
